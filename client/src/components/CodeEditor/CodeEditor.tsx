...
export type CodeEditorStyleType = SyntaxHighlighterStyleType & {
    ...
    /**
     * Use the property to align the text input with the syntax highlighter text.
     * @see highlighterLineHeight
     */
    inputLineHeight?: number;

    /**
     * Use the property to help you align the text input with the syntax highlighter text.
